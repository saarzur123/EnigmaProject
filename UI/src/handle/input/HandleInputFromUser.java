...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public boolean getAndValidateRotorsByOrderFromUser(int totalRotorsNumbers, int mustInUseRotors,LinkedList<Integer> rotorsId){
        final String INPUT_MSG = "Please enter "+ mustInUseRotors +" unique rotors id's in a decimal number that you wish to create your secret code from, in the order of Right to Left seperated with a comma:" + System.lineSeparator()
        ...
        do{
            ...
            if(!isValid){
                ...
                isExit = SecretCodeValidations.handleRotorsIdExit(doUserWntToExit(INPUT_MSG),rotorsId);
            }
    ...
    public boolean getAndValidateRotorsStartPositionFromUser(int mustInUseRotors,String abc, List<Character> startPos){
        final String INPUT_MSG = "Please enter "+mustInUseRotors+" rotors start positions from Right to Left not seperated with anything (Notice the start position characters should be from "+ abc+" ):" + System.lineSeparator()
        ...
        do{
            ...
            if(!isValid) {
                errorMsgForUser(errorMsg);
                isExit = SecretCodeValidations.handlePositionsExit(doUserWntToExit(INPUT_MSG), startPos);
            }
            errorMsg.delete(0,errorMsg.length());
        }while (!isValid && !isExit);
    ...
    public String outPutMsgForUserInputPlugBoard(String abc){
        final String INPUT_MSG = "Please enter any plugs , press enter if you don't want to add plugs." + System.lineSeparator()
